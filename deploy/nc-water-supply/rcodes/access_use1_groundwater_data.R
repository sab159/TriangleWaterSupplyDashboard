...
#remove files
rm(zt, gw.annual, recent.flow, current.stat, current.stat2, gw.stats, nc.sites2, nc.sites, usgs.sites, stats, year.flow, usgs.sites, dwr.sites, stats2, test, url.sites, year.flow2, a.test, zt.stats)
