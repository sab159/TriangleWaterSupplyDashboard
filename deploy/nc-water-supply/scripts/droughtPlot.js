...
//load current demand
  d3.csv("data/drought/percentAreaHUC.csv").then(function(drought){
...
var selDrought = drought.filter(function(d){ return d.huc8 === myHUC; });
var currentDrought = selDrought[Object.keys(selDrought)[Object.keys(selDrought).length - 1]];
...
yNone = selDrought.map(function(d){ return d.none; });  yd0 = selDrought.map(function(d) { return d.d0x; });
yd1 = selDrought.map(function(d) { return d.d1x; });    yd2 = selDrought.map(function(d) { return d.d2x; });
yd3 = selDrought.map(function(d) { return d.d3x; });    yd4 = selDrought.map(function(d) { return d.d4x; });
...
var layout = {
  ...
  Plotly.newPlot('droughtPlot', data, layout);
