...
1. For each row in `registry`, download the XLSX template and and upload any NEW data to the SensorThings endpoint
   i. If the PWSID is not already represented in the XLSX template, then the entire data model will need to be populated.
```{r read2}
   x <- 1
```
      i. First
